...
export class BidAskSchema extends jspb.Message { 
    getPrice(): number;
    ...
    toObject(includeInstance?: boolean): BidAskSchema.AsObject;
    static toObject(includeInstance: boolean, msg: BidAskSchema): BidAskSchema.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: BidAskSchema, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): BidAskSchema;
    static deserializeBinaryFromReader(message: BidAskSchema, reader: jspb.BinaryReader): BidAskSchema;
}

export namespace BidAskSchema {
...
export class OrderBook extends jspb.Message { 
    ...
    addBids(value?: BidAskSchema, index?: number): BidAskSchema;

    clearAsksList(): void;
    getAsksList(): Array<BidAskSchema>;
    setAsksList(value: Array<BidAskSchema>): void;
    addAsks(value?: BidAskSchema, index?: number): BidAskSchema;
