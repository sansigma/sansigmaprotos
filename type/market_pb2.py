...
_MARKET = _descriptor.Descriptor(
  name='Market',
  full_name='ssigma.type.Market',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='symbol', full_name='ssigma.type.Market.symbol', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='exchange', full_name='ssigma.type.Market.exchange', index=1,
...
Market = _reflection.GeneratedProtocolMessageType('Market', (_message.Message,), dict(
  DESCRIPTOR = _MARKET,
  __module__ = 'sansigmaprotos.type.market_pb2'
  # @@protoc_insertion_point(class_scope:ssigma.type.Market)
  ))
